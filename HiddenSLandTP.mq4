...
//First define name of hidden stoploss and takeprofit
   string strSL = "HL_SL_"+IntegerToString(this.m_intTicket);
   string strTP = "HL_TP_"+IntegerToString(this.m_intTicket);
   string strHSL = "HL_HSL_"+IntegerToString(this.m_intTicket);
   string strHTP = "HL_HTP_"+IntegerToString(this.m_intTicket);

//Delete the lines
   this.DeleteLine(strSL);
   this.DeleteLine(strTP);
   this.DeleteLine(strHSL);
   this.DeleteLine(strHTP);
   
//Now add the lines.
   this.CreateHorizontalLine(strSL,this.m_dblStopLoss,clrOrange,STYLE_SOLID,2,True);
   this.CreateHorizontalLine(strTP,this.m_dblTakeProfit,clrGreen,STYLE_SOLID,2,True);
   this.CreateHorizontalLine(strHSL,this.m_dblHiddenStopLoss,clrLightPink,STYLE_SOLID,4,True);
   this.CreateHorizontalLine(strHTP,this.m_dblHiddenTakeProfit,clrLightGreen,STYLE_SOLID,4,True);
